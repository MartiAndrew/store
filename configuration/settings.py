...
class Settings(BaseSettings):
    ...
    Просьба все, что вы будете добавлять тоже как-то классифицировать,
    а не кидать в корень.
    В секции if TYPE_CHECKING подключены все существующие сервисы из common.
    Все эти сервисы можно закинуть автоматов в настройки при генерации.
